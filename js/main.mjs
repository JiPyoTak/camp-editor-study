...
const button = body.querySelector('.add-btn');
const selectedBtn = body.querySelector('.selected-btn')

button.addEventListener('click', (event) => {
  const child = document.createElement('p');
  child.innerHTML = textarea.value;
...
selectedBtn.addEventListener('click', (event) => {
  ...
  const before = anchorNode.previousSibling;
  const after = anchorNode.nextSibling;
